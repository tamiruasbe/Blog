...
import EdittPost from './creator/EdittPost';
...
//HOC
const CreatorDashboardHOC = Layout(CreatorDashboard)
const AdminDashboardHOC = Layout(AdminDashboard);
const CreaterPostHOC = Layout(CreatorPost);
const EdittPostHOC = Layout(EdittPost);
        ...
        <ProSidebarProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path='/creator/post/create' element={<CreatorRoute><CreaterPostHOC /></CreatorRoute>} />
              <Route path='/creator/post/edit/:id' element={<CreatorRoute><EdittPostHOC /></CreatorRoute>} />
